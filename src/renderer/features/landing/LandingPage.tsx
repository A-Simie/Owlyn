      ...
      <main className="pt-20">
              ...
              <div className="relative flex items-center justify-center w-64 h-64">
                {[
                  ...
                  <motion.div
                    ...
                    animate={{
                      scale: [ring.s, ring.s + 0.05, ring.s],
                      opacity: [ring.o, ring.o + 0.1, ring.o],
                    }}
                    transition={{
                      duration: 3 + i,
                      repeat: Infinity,
            ...
            {[
              {
                icon: "visibility",
                title: "Voice & Vision",
                desc: "Reactive follow-ups driven by computer vision and acoustic analysis. Owlyn interprets non-verbal cues to understand the candidate's true confidence.",
              },
              {
                icon: "psychology",
                title: "Real-time Reasoning",
                desc: "Adaptive difficulty spikes that evolve based on candidate performance. The AI pivots instantly to explore the boundaries of technical expertise.",
              },
              {
                icon: "verified_user",
                title: "Integrity Guard",
                desc: "Multimodal security monitoring ensures the highest standards of excellence. Patent-pending detection for unauthorized AI assistance or external coaching.",
              },
            ].map((f, i) => (
              <motion.div
                key={f.title}
              ...
              >
                ...
                <h3 className="text-xl font-bold text-heading mb-4 tracking-wide uppercase">
                  {f.title}
                </h3>
        ...
        <section className="py-24 border-t divider bg-slate-50 dark:bg-[#0B0B0B]">
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-heading mb-4 tracking-tight">
                The Owlyn Protocol
              </h2>
              <p className="text-primary uppercase tracking-[0.3em] text-[11px] font-bold">
                A four-stage multimodal evaluation framework
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  desc: "Recruiters define the AI's personality, knowledge base, and specific evaluation criteria for the role.",
                },
                {
                  num: 2,
                  icon: "fingerprint",
                  title: "Candidate Calibration",
                  desc: "A secure hardware and identity check ensures the candidate is ready and the environment is controlled.",
                },
                {
                  num: 3,
                  icon: "record_voice_over",
                  title: "Multimodal Interview",
                  desc: "The live, real-time session where Owlyn listens, sees, and adapts to the candidate's responses.",
                },
                {
                  num: 4,
                  icon: "analytics",
                  title: "Deep Intelligence",
                  desc: "AI-generated scores, competency radars, and transcript highlights are delivered instantly.",
                },
              ].map((step, i) => (
                <motion.div
                  key={step.num}
                ...
                >
                  ...
                  <h4 className="text-lg font-bold text-heading mb-3 uppercase tracking-wide">
                    {step.title}
                  </h4>
        ...
        <section className="py-20 border-t divider bg-white/80 dark:bg-black/40 overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              {["QUANTUM", "STRATOS", "VANGUARD", "AETHER", "NODAL"].map(
                (name, i) => (
                  <motion.div
                    key={name}
                    variants={fadeUp}
