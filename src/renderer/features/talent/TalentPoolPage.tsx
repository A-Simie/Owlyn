      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        <section className="flex-1 flex flex-col surface relative overflow-hidden">
          ...
          <div className="p-8 flex-1 overflow-y-auto">
            ...
            <div className="rounded-xl surface-card overflow-hidden border border-slate-100 dark:border-primary/10">
        ...
        <aside className="w-80 border-l divider surface-alt flex flex-col overflow-hidden">
          ...
          <div className="p-6 bg-primary/5">
            <button className="w-full flex items-center justify-between group">
              <span className="text-xs font-bold text-body group-hover:text-primary transition-colors">
                View All Activity
              </span>
